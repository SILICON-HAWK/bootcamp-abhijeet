import './style.scss';
import { displayStudentDataFromJSON } from './script.ts';
import { addStudent } from './addStudent.ts';
import { addStudentDummy } from './addStudentDummy.ts';
import { changeFont } from './changeFont.ts';
import { displayBrowserInfo } from './displayBrowserInfo.ts';
